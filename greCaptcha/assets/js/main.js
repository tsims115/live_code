...
function submitToAPI(e) {
  ...
  $.ajax({
    type: "POST",
    url : "https://mlupoth013.execute-api.us-east-1.amazonaws.com/alpha/contact",
    dataType: "json",
    crossDomain: "true",
...
function verify(token) {
  $.ajax({
    type: "POST",
    url : "https://n38cawad9h.execute-api.us-east-1.amazonaws.com/alpha/verify",
    dataType: "json",
    crossDomain: "true",
    contentType: "application/json; charset=utf-8",
